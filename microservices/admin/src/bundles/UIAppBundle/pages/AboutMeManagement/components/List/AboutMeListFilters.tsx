...
import { AboutMeListFiltersForm } from "../../config/AboutMeListFiltersForm";

type AboutMeListFiltersProps = {
  onUpdate: (filters: any) => void;
};

export const AboutMeListFilters = React.memo(AboutMeListFiltersBase);

export function AboutMeListFiltersBase(props: AboutMeListFiltersProps) {
  ...
  const filterForm = use(AboutMeListFiltersForm, { transient: true });
  filterForm.build();
