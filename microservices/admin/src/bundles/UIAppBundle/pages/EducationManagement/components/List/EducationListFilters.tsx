...
import { EducationListFiltersForm } from "../../config/EducationListFiltersForm";

type EducationListFiltersProps = {
  onUpdate: (filters: any) => void;
};

export const EducationListFilters = React.memo(EducationListFiltersBase);

export function EducationListFiltersBase(props: EducationListFiltersProps) {
  ...
  const filterForm = use(EducationListFiltersForm, { transient: true });
  filterForm.build();
