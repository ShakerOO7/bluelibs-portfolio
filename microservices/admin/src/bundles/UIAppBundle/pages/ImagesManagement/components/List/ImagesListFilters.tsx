...
import { ImageListFiltersForm } from "../../config/ImageListFiltersForm";

type ImagesListFiltersProps = {
  onUpdate: (filters: any) => void;
};

export const ImagesListFilters = React.memo(ImagesListFiltersBase);

export function ImagesListFiltersBase(props: ImagesListFiltersProps) {
  ...
  const filterForm = use(ImageListFiltersForm, { transient: true });
  filterForm.build();
