...
import { ProjectListFiltersForm } from "../../config/ProjectListFiltersForm";

type ProjectsListFiltersProps = {
  onUpdate: (filters: any) => void;
};

export const ProjectsListFilters = React.memo(ProjectsListFiltersBase);

export function ProjectsListFiltersBase(props: ProjectsListFiltersProps) {
  ...
  const filterForm = use(ProjectListFiltersForm, { transient: true });
  filterForm.build();
