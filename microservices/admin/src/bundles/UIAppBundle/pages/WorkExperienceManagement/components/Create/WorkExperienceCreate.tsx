...
import { WorkExperienceCreateForm } from "../../config/WorkExperienceCreateForm";
import {
  WorkExperience,
...
export function WorkExperienceCreate() {
  ...
  const form = use(WorkExperienceCreateForm, { transient: true });
  form.build();

  return (
    <UIComponents.AdminLayout>
      <Ant.PageHeader
        title={t("management.work_experience.create.header")}
